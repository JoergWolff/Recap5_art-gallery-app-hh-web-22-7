...
First create a new Next.js app based on our template: https://github.com/mbosselmann/art-gallery-app-hh-web-22-7
...
- [ ] Install the package `swr`
- [ ] Fetch all art pieces with `useSWR` in `pages/index.js`
